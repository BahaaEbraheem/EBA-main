...
namespace OA.Domin.DSA
{
    ...
    public static class Names
    {
        ...
        {
            public const string EntityName = "New";
            public const string Controller = "api/News";
            public const string Policy = "events-control";
            public static class Routes
            {
                public const string List = "News/List";
                public const string Create = "New/Create";
                public const string Edit = "New/Edit/{id}";
                public const string Details = "New/Details/{id}";
            }
        }
