...
namespace OA_API.Controllers.DSA
{
    ...
    [ApiController]
    public class ExternalAdministrationBoardsController : ControllerBase
    {
        private readonly IAdministrationBoardService AdministrationBoardService;
    private readonly AppDbContext Context;
    private readonly UploadService UploadService;

    public ExternalAdministrationBoardsController(IAdministrationBoardService donationService, AppDbContext context, UploadService uploadService)
    {
        Context = context;
        AdministrationBoardService = donationService;
        UploadService = uploadService;
    }

    [HttpPost("AdministrationBoardCreate")]
